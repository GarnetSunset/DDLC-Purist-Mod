...
transform face_one(z=0.80, y=300):
    subpixel True
    xcenter 640
    yanchor 1.0 ypos 1.03
    yoffset y
...
transform face_two(z=0.80, y=375):
    subpixel True
    xcenter 640
    yanchor 1.0 ypos 1.03
    yoffset y
...
transform face_three(z=0.80, y=600):
    subpixel True
    xcenter 640
    yanchor 1.0 ypos 1.03
    yoffset y
...
define wiperight = ImageDissolve("images/menu/wiperight.png", 0.5, ramplen=64)
define wipedown = ImageDissolve("images/menu/wipedown.png", 0.5, ramplen=64)
define wipeup = ImageDissolve("images/menu/wipeup.png", 0.5, ramplen=64)
