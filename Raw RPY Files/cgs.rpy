...
# big list of Monika expressions
image m_angry1:
    im.Scale("images/monika/angry/angry1.png", 1280, 720)
image m_disgust1:
    im.Scale("images/monika/angry/disgust1.png", 1280, 720)
image m_unhappy1:
    im.Scale("images/monika/angry/unhappy1.png", 1280, 720)
image m_unhappy2:
    im.Scale("images/monika/angry/unhappy2.png", 1280, 720)

image m_neutral1:
    im.Scale("images/monika/neutral/neutral1.png", 1280, 720)
image m_neutral2:
    im.Scale("images/monika/neutral/neutral2.png", 1280, 720)
image m_smug:
    im.Scale("images/monika/neutral/smug.png", 1280, 720)
image m_thoughtful:
    im.Scale("images/monika/neutral/thoughtful.png", 1280, 720)

image m_crying:
    im.Scale("images/monika/suffering/crying.png", 1280, 720)
image m_tearyAngry:
    im.Scale("images/monika/suffering/tearyAngry.png", 1280, 720)
image m_tearyUpset:
    im.Scale("images/monika/suffering/tearyUpset.png", 1280, 720)
image m_teary:
    im.Scale("images/monika/suffering/teary.png", 1280, 720)

image m_confused1:
    im.Scale("images/monika/worried/confused1.png", 1280, 720)
image m_confused2:
    im.Scale("images/monika/worried/confused2.png", 1280, 720)
image m_nervous:
    im.Scale("images/monika/worried/nervous.png", 1280, 720)
image m_startled:
    im.Scale("images/monika/worried/startled.png", 1280, 720)
image m_surprise:
    im.Scale("images/monika/worried/surprise.png", 1280, 720)
image m_worried:
    im.Scale("images/monika/worried/worried.png", 1280, 720)