...
# adding the OST here
define audio.titleTheme = "<loop 0>bgm/OST/Title_Theme.ogg"
define audio.aNewDay = "<loop 0>bgm/OST/A_New_Day.ogg"
define audio.NatTheme = "<loop 0>bgm/OST/Thinking_Of_Excuses-Natsukis_Theme.ogg"
define audio.SayTheme = "<loop 0>bgm/OST/Rainclouds_And_Sunshine-Sayoris_Theme.ogg"
define audio.YurTheme = "<loop 0>bgm/OST/Amber_Heart-Yuris_Theme.ogg"
define audio.MonTheme = "<loop 0>bgm/OST/Something_Real-Monikas-Theme.ogg"
define audio.Bunkasai = "<loop 0>bgm/OST/Bunkasai.ogg"
define audio.Thoughts = "<loop 0>bgm/OST/Thoughts_and_Crosses.ogg"
define audio.EarlyBird = "<loop 0>bgm/OST/The_Early_Bird.ogg"
define audio.NextToYou = "<loop 0>bgm/OST/Next_to_You.ogg"
define audio.Dusk = "<loop 0>bgm/OST/Dusk.ogg"
define audio.Dawn = "<loop 0>bgm/OST/Dawn.ogg"
define audio.AfterAll = "<loop 0>bgm/OST/After_All.ogg"
define audio.Brick = "<loop 0>bgm/OST/Brick_by_Brick.ogg"
define audio.LettingGo = "<loop 0>bgm/OST/Letting_Go.ogg"
define audio.AllGoodThings = "bgm/OST/All_Good_Things-Credits_Theme.ogg"
define audio.Amber = "<loop 0>bgm/OST/amber.ogg"
define audio.Excuses = "<loop 0>bgm/OST/excuses.ogg"
define audio.Rainclouds = "<loop 0>bgm/OST/rainclouds.ogg"
define audio.Reality = "<loop 0>bgm/OST/reality.ogg"
...
# additional bgs we add
image bg home_interior = "bg/home-interior.png"
image bg home_interior_afternoon = "bg/home-interior-afternoon.png"
image bg home_interior_night = "bg/home_interior_night.png"
image bg house_entrance = "bg/house-entrance.png" # credit goes to Minikle with edits by Nuxill#7870
image bg house_entrance_night = "bg/house_entrance_night.png" # credit goes to Minikle with edits by Nuxill#7870
image bg park_day:
    im.Scale("bg/park-day.png", 1280, 720)
image bg park_rain:
    im.Scale(im.MatrixColor("bg/park-day.png",im.matrix.saturation(0.5)*im.matrix.tint(.97,.84,.65)*im.matrix.brightness(-0.2)), 1280, 720)
image bg park_night:
    im.Scale("bg/park-night.png", 1280, 720)
#image bg park_night = "bg/park-night.png"
image bg residential_night = "bg/residential-night.png"
image bg school_yard:
    im.Scale("bg/school_yard.png", 1280, 720)
#image bg school_yard_night = "bg/school_yard_night.png"
image bg streets_day = "bg/streets-day.png"
image bg streets_afternoon = "bg/streets_afternoon.png"
image bg streets_night = "bg/streets-night.png"
image bg tower_day:
    im.Scale("bg/tower_day.png", 1280, 720)
image bg tower_night:
    im.Scale("bg/tower_night.png", 1280, 720)
image bg tower_sunset:
    im.Scale("bg/tower-sunset.png", 1280, 720)
image bg class_night = im.MatrixColor("bg/class.png",im.matrix.saturation(0.5)*im.matrix.tint(.97,.84,.65)*im.matrix.brightness(-0.2))
image bg bedroom_night = "bg/bedroom_night.png"
image bg classroom_dark_night = "bg/classroom_night.png"
image bg clubroom_night = "bg/clubroom_night.png"
...
image bg space_night = "bg/space_night.png"
image bg dark_streets = "bg/residential_original_night.png" 
image bg sky_day: # https://lemmasoft.renai.us/forums/viewtopic.php?t=15568
    im.Scale("bg/sky_day.png", 1280, 720)
image bg flashback_home = im.Sepia("bg/home-interior.png")
image bg sky_night = "bg/sky_night.png" # https://lemmasoft.renai.us/forums/viewtopic.php?t=15568
#image bg rooftop = "bg/rooftop_day.png"
image bg rooftop:
    im.Scale("bg/rooftop_day.png", 1280, 720)
#image bg rooftop_night = "bg/rooftop_night.png"
image bg rooftop_night:
    im.Scale("bg/rooftop_night.png", 1280, 720)
image bg noise1 = "bg/noise1.png"
image bg grocery = "bg/grocery.png"
image bg sayoriChocolate1:
    im.Scale("cg/sayoriChocolate1.png", 1280, 720)
image bg sayoriChocolate2:
    im.Scale("cg/sayoriChocolate2.png", 1280, 720)
image bg sayoriChocolate3:
    im.Scale("cg/sayoriChocolate3.png", 1280, 720)
image bg sayoriChocolate4:
    im.Scale("cg/sayoriChocolate4.png", 1280, 720)    

image bg sayoriKiss = "cg/sayoriKiss.png"
image bg cafe = "bg/cafe.png" # by UncleMugen, from Café Memoria
image bg bookstore = "bg/bookstore.png" # by QQQnoQno with edits done by Nuxil#7870
image bg fastfood = "bg/fastfood.png" # by UncleMugen, from Café Memoria
image bg residential_rain = "bg/Residential_Rain2.png"
image bg graveyard = "bg/cemetary.png"
image bg restaurant:
    im.Scale("bg/restaurant.png", 1280, 720)
image bg natsukiCG1:
    im.Scale("cg/natsukiCG1.png", 1280, 720)

image bg club_LIT = im.MatrixColor("bg/club.png",im.matrix.saturation(0.5)*im.matrix.tint(.97,.84,.65)*im.matrix.brightness(-0.2))

#image modCreditLogo = "menu/puristmodlogo.png"
...
# addition sfx
define audio.alarm = "sfx/alarm.ogg" # found here: https://freesound.org/people/SpliceSound/sounds/369879/
define audio.paalert = "sfx/paalert.ogg" # found here: https://freesound.org/people/jppi_Stu/sounds/274682/
define audio.crowds = "sfx/crowds.ogg" # found here: https://freesound.org/people/eguobyte/sounds/360703/
define audio.slap = "sfx/slap.ogg" # where's this come from? I apparently DL'd it from somewhere before I needed a slap sound? - wait no is from base DDLC
define audio.fireworks = "sfx/fireworks.ogg" # from: https://freesound.org/people/waxsocks/sounds/254836/

define audio.thunder = "sfx/thunder.ogg" # thunder https://freesound.org/people/InspectorJ/sounds/360328/
define audio.rain = "sfx/rain.ogg" # rain https://freesound.org/people/lebaston100/sounds/243627/
define audio.bell = "sfx/schoolbell.ogg" # https://freesound.org/people/13FPanska_Stranska_Michaela/sounds/378394/
define audio.buzz = "sfx/buzz.ogg" # ttps://freesound.org/people/poison%20x/sounds/242000/
define audio.bleep = "sfx/bleep.ogg" # https://freesound.org/people/PoisonedDuumDuumYT/sounds/429677/
define audio.punishment = "sfx/punishment.ogg" # https://freesound.org/people/nebulasnails/sounds/405538/
image difficulties = "cg/difficulties.png"
define audio.boomstick = "sfx/boomstick.ogg" # https://freesound.org/people/IchBinJager/sounds/272068/
define audio.boomstickfire = "sfx/boomstickfire.ogg" # https://freesound.org/people/michorvath/sounds/427595/
define artillery = "sfx/artillery.ogg" # https://freesound.org/people/EFlexTheSoundDesigner/sounds/388528/

image bg monikaCG1 = "cg/monikacg1.png"
image bg monikaCG2: # open eyes
    im.Scale("cg/monikaCG2.png", 1280, 720)
image bg monikaCG2b: # closed eyes
    im.Scale("cg/monikaCG2-2.png", 1280, 720)
image bg yuri_cg1a: # has some tears
    im.Scale("cg/yuriCG1.png", 1280, 720)
image bg yuri_cg1b: # cry smile
    im.Scale("cg/yuriCG2.png", 1280, 720)
image bg yuri_cg1c: # smile
    im.Scale("cg/yuriCG3.png", 1280, 720)
image bg yuri_cg1d: # no cry
    im.Scale("cg/yuriCG4.png", 1280, 720)

image guiFrame = "gui/frame.png"
...
image sayori 7a = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/da.png") # testing
image sayori 7b = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/db.png")
image sayori 7c = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dc.png")
image sayori 7d = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dd.png")
image sayori 7e = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/de.png")
image sayori 7f = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/df.png")
image sayori 7g = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dg.png")
image sayori 7h = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dh.png")
image sayori 7i = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/di.png")
image sayori 7j = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dj.png")
image sayori 7k = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dk.png")
image sayori 7l = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dl.png")
image sayori 7m = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dm.png")
image sayori 7n = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dn.png")
image sayori 7o = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/do.png")
image sayori 7p = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dp.png")
image sayori 7q = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dq.png")
image sayori 7r = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dr.png")
image sayori 7s = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/ds.png")
image sayori 7t = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dt.png")
image sayori 7u = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/du.png")
image sayori 7v = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dv.png")
image sayori 7w = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dw.png")
image sayori 7x = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dx.png")
image sayori 7y = im.Composite((960, 960), (0, 0), "sayori/d1.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dy.png")

image sayori 6a = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/da.png")
image sayori 6b = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/db.png")
image sayori 6c = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dc.png")
image sayori 6d = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dd.png")
image sayori 6e = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/de.png")
image sayori 6f = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/df.png")
image sayori 6g = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dg.png")
image sayori 6h = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dh.png")
image sayori 6i = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/di.png")
image sayori 6j = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dj.png")
image sayori 6k = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dk.png")
image sayori 6l = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dl.png")
image sayori 6m = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dm.png")
image sayori 6n = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dn.png")
image sayori 6o = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/do.png")
image sayori 6p = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dp.png")
image sayori 6q = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dq.png")
image sayori 6r = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dr.png")
image sayori 6s = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/ds.png")
image sayori 6t = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dt.png")
image sayori 6u = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/du.png")
image sayori 6v = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dv.png")
image sayori 6w = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dw.png")
image sayori 6x = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dx.png")
image sayori 6y = im.Composite((960, 960), (0, 0), "sayori/d2.png", (0, 0), "sayori/d3.png", (0, 0), "sayori/dy.png")
...
# BIG LIST OF MONIKA CGS HOLY SHIT
# or not, look in cgs.rpy for more neatness
...
define o = DynamicCharacter('o_name', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed") # FOR ANYONE NOT A MAIN CAST
define p = DynamicCharacter('p_name', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define d = DynamicCharacter('d_name', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define ny = Character('Nat & Yuri', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define b = Character('Boy', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define g = Character('Girl', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
...
default persistent.opening_scene = False
# Boolean for Monika route unlock
default persistent.monika_unlock = False
# Boolean for if you got the bad end
default persistent.got_monika_bad_end = False
# non persientnt but helps with call stack
default monika_route_lock = False
default monika_route_position = 1 # choice 1
# trackers for routing
default sayoriRoutePoints = 0
default natsukiRoutePoints = 0
default yuriRoutePoints = 0
default firstWeekendPick = True
default natsukiRoute = False
default yuriRoute = False
default sayoriRoute = True
default makeComplex = False
default askAboutDate = False
default confrontDad = False
default readManga = False
default natsukiGoodEnd = True

default persistent.natsukiCompletedGood = False
default persistent.yuriCompletedGood = False 
default persistent.sayoriCompletedGood = False

default persistent.natsukiBadInterludeViewed = False
default saveLocked = False

default playerNameBackwards = "" # YEAH SCREW YOU TOO NINJA YOUR ROUTE IS SO HIGH MAINTENANCE LOL
default firstThreeChars = "" # I hate the Yuri route for this

default sayori_affection = 0
default sayori_please_clap = False
default sayori_flag_one = False
default sayori_flag_two = False # SO MUCH HIGH MAINTENANCE I S2G
default sayori_goodEnd = True
default sayori_informal = True

default yuri_gPoints = 0
default yuri_bPoints = 0 # two values, TWO values
default yuri_coward = True # you'll never guess what this is for

#default yuri_goodEnd = True
default yuri_badEnd1 = False
default yuri_badEnd2 = False # yeah just check for both false for monika dialogue

default persistent.yuriBadInterlude1Viewed = False
default persistent.yuriBadInterlude2Viewed = False
default persistent.yuriGoodInterludeViewed = False

default persistent.sayoriBadInterludeViewed = False
default persistent.sayoriGoodInterludeViewed = False

default weekendSayori = False
default weekendMonika = False

default monika_bad_end = False

# these are here to facilitate the choices for the festival
default monikaFestival_maidCafe = False
default monikaFestival_hauntedHouse = False
default monikaFestival_food = False
default monikaFestival_fortuneTeller = False
default saidIt = False

# these are here to keep track of how many times you've been to Monika
default persistent.natsukiRouteCompletions = 0
default persistent.sayoriRouteCompletions = 0
default persistent.yuriRouteCompletions = 0

default persistent.timesTried = 0
default persistent.skipped = False
default secretCode = ""

# main menu shenanigans
default persistent.natsukiRouteStarted = False
default persistent.yuriRouteStarted = False
default persistent.sayoriRouteStarted = False
default persistent.monikaRouteStarted = False
...
default y_name = "Yuri"
default o_name = "Other"
default p_name = "Phone"
default d_name = "Nat's Dad"
