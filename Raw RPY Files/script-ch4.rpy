label ch4_main:
    ...
    # if Sayori route, return
    # tl;dr you need 3 points with another girl to get to her route
    # otherwise you are routed to Sayori by default, so if you go 2/2, default to Sayori
    if(yuriRoutePoints>=3 or natsukiRoutePoints>=3):
        # continue normally
        scene bg residential_day with wipeleft_scene
        $sayoriRoute = False
    else:
    # sayori's route trigger
        #m "lol filler"
        $sayoriRoute = True
        return
...
label ch4_exclusive_natsuki:
    ...
    n "M-monika--"
    m 1k "Hm? Don't mind me."
    mc "Monika--?!"
    mc "Sayori said she was just helping you online--"
    m "I changed my mind and decided to come over."
    #mc "A-anyways, just now, we weren't--"
    mc "Anyways, M-monika, just now, we weren't--"
    m 3b "Haha, don't worry."
    m "Your secret is safe with me~"
    m "I was just on my way to Sayori's house, since our work for the festival won't get itself done."
    m "Especially if I'm not actually online~"
    show monika 1a at t21
    n 1bq "R-right, you were going to help her."
    n "Anyways, I'm already on my way out, so..."
    m 1f "Aw, really?"
    m "I was hoping we could talk at Sayori's."
    m "It's been a while since it's been just us girls~"
    show monika 1f at t21
    n 1br "Yeah, well..."
    n "We can talk at the festival tomorrow, so it's fine."
    n 4bq "Just don't eat any cupcakes before then, [player]!"
    n "Anyway, later!"
...
label ch4_exclusive_yuri:
    ...
    mc "Eh?!"
    m "Ah..."
    m 1k "Don't let me get in the way, ahaha."
    mc "Monika--!"
    mc "Sayori said she was just helping online--"
    m "I changed my mind and decided to come over."
    mc "A-anyways, just now, we weren't--"
    m 3b "Oh, I know."
    m "Don't worry, your secret is safe with me."
    m 1b "I won't say a word."
    m "I was just on my way to Sayori's, our work for the festival won't get itself done."
    m "Especially if I'm not online~"
    show monika 1a at t21
    y 3bq "U-um..."
...
label ch4_end:
    ...
    # okay Monika patch job goes here
    show monika 1d at t32
    m "Not Sayori, hm?"
    show monika 1c at t32
    mc "I..."
    m 1d "She's already told you what she's going through, right?"
    "I try to open my mouth, but nothing comes out."
    "I was about to ask how she knew, but it's likely that Sayori's told Monika about things."
    "They seem like close friends, after all."
    "I..."
    m 1r "Don't worry about it."
    mc "What...?"
    m 1i "If you're going to go after someone or something, don't do it half-heartedly."
    m "So don't worry."
    m "I'll take care of things so you can focus on what's ahead of you."
    m 1j "Hehehe."
    "Monika gives an enigmatic laugh."
    m 1n "Even if you try to save everyone, you can only do it one at a time, huh?"
    m 1r "I guess even you have your limits."
    m "Or maybe that's how you wanted things..."
    # m "After all, you don't <i>seem</i> like the harem type."
    m "But it hardly matters."
    m 1i "I'll handle what you can't."
    m 1p "It's not like I have much to do, anyways."
    mc "Monika--"
    m 1d "Hm?"
    mc "Um..."
    mc "I don't really know what to say, but... thanks."
    m 5a "Hehehe."
    m "Alright."
    m "See you tomorrow at the festival, [player]."
    hide monika with wiperight
    "With that, Monika gives a wave as she goes towards Sayori's house."
    "Alright..."
    "I guess I better go rest for the festival tomorrow."
